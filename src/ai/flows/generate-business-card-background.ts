 ...
 *
 * - generateCardBackground - A function that generates a card background from a website URL.
...
const generateCardBackgroundPrompt = ai.definePrompt({
  ...
  input: {schema: GenerateCardBackgroundInputSchema},
  output: {schema: GenerateCardBackgroundOutputSchema},
